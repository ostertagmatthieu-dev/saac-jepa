...
\definecolor{mnorm}{HTML}{CDEFD9}  \definecolor{mnormL}{HTML}{1E8C50} % RevIN variant (dashed)
...
\tikzset{
  ...
  nrm/.style ={blk, fill=mnorm, draw=mnormL, dashed, font=\sffamily\scriptsize, minimum height=7mm, inner xsep=2mm},
