...
\foreach [count=\k from 0] \name/\capt in {%
  random/interpolation locale, block/dynamique temporelle,
  channel/\textbf{capteur absent}, event/zones actives, mixed/combin\'e}{
...
\end{scope}
\node[sub, text=mgreenL] at (7.1,-2.55) {le gagnant M03 utilise \textbf{channel} (0{,}35)};
...
\node[sub] at (7.6,-7.0)
  {RMSE val : token 0{,}832 $\approx$ FiLM 0{,}830 $<$ cross-attn 0{,}847 --- l'expressivit\'e ne paie pas \`a cette \'echelle de donn\'ees};
