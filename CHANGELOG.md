...
- The paper is retitled *World Models for Cross-Machine CNC Transfer under Partial Sensor Overlap*
  (revised arXiv version 2609.16071v2 of the same V1 paper, announced @REVISION_DATE@), after Jean Ponce's review: the method acronym
  ...
  `bouaziz2026schemaadaptiveactionconditionedjepacrossmachine` to `@NEW_KEY@`, copied from the abs
